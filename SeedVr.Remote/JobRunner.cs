...
namespace SeedVr.Remote
{
    ...
    public class JobRunner
    {
        ...
        public JobRunner(ComfyUiClient comfyUiClient, ComfyProgressClient comfyProgressClient, ComfyWrapperClient comfyWrapperClient, WrapperProgressClient wrapperProgressClient, JupyterClient jupyterClient, WorkflowBuilder workflowBuilder, VideoProbe videoProbe, IOptions<AppSettings> appSettingsOptions)
        {
        ...
        public async Task<bool> StartRawJob(string comfyUiAddress, string jupyterAddress, string jupyterToken, CancellationToken cancellationToken)
        {
            ...
            catch (OperationCanceledException) when (cancellationToken.IsCancellationRequested)
            {
                ...
                await RecoverLatchedGpuMemory(comfyUiAddress, jupyterAddress, jupyterToken);
                throw;
            }
        ...
        private async Task RecoverLatchedGpuMemory(string comfyUiAddress, string jupyterAddress, string jupyterToken)
        {
